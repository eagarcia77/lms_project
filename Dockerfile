...
# home administration access and administration layers while applying V3.
RUN mkdir -p /tmp/nexus-overlay/app \
    && cp app/unified_authoring.py app/innovation_hub.py app/admin_portal.py app/role_management.py app/home_admin_access.py app/production_entry.py app/admin_authoring_v6.py app/admin_console.py app/admin_system.py /tmp/nexus-overlay/app/ \
