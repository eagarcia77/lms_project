...
def main() -> None:
    ...
    if NEW_NAV not in source:
        if OLD_NAV not in source:
            raise RuntimeError("No se encontró la navegación original del portal integrado.")
    ...
    print(f"Portal integrado actualizado con navegación por roles; cambios: {changed}.", flush=True)
